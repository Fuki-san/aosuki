...
//あおすきについて、dashboardから
Route::get('/aboutaosuki', function () {
    return view('columns/aboutaosuki');
})->name('aboutaosuki');

Route::get('/bwstuevent', function () {
    return view('columns/bwstuevent');
})->name('bwstuevent');

Route::get('/onlystuevent', function () {
    return view('columns/onlystuevent');
})->name('onlystuevent');

Route::get('/aoharureport', function () {
    return view('columns/aoharureport');
})->name('aoharureport');

Route::get('/priceplan', function () {
    return view('columns/priceplan');
})->name('priceplan');
Route::get('/announcement', function () {
    return view('columns/announcement');
})->name('announcement');
