<x-app-layout>
    <div class="container lg:w-3/4 md:w-4/5 w-11/12 mx-auto my-8 px-8 py-4 bg-white shadow-md">
        <article class="mb-2">
            ...
            <p class="text-gray-700 text-base">{!! nl2br(e($talk->body)) !!}</p>
        </article>
        <div class="flex flex-row text-center my-4">
            <a href="{{ route('talks.edit', $post) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-20 mr-2">編集</a>
