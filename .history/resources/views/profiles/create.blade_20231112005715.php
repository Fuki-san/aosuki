<x-form-section submit="creatematch">
    ...
    <div x-data="{ shown: false, timeout: null }" x-init="shown = @entangle('state.shown').defer" x-show.transition.out.opacity.duration.1500ms="shown"
        x-transition:leave.opacity.duration.1500ms style="display: none;" class="text-sm text-gray-600">
