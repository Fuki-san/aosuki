<x-form-section submit="creatematch">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="dislike" type="text" class="mt-1 block w-full" wire:model="state.hobby" required />
            <x-input-error for="dislike" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-label for="mbti" value="{{ __('MBTI') }}" />
            <x-input id="mbti" type="text" class="mt-1 block w-full" wire:model="state.hobby" required />
