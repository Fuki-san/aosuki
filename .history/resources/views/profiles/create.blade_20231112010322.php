<x-form-section submit="creatematch">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="nickname" value="{{ __('ニックネーム') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="smoking" value="{{ __('煙草') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="distance" value="{{ __('距離') }}" />
            <x-input id="distance" type="integer" class="mt-1 block w-full" wire:model="state.distance" required />
            <x-input-error for="distance" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-label for="where" value="{{ __('場所') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="age" type="integer" class="mt-1 block w-full" wire:model="state.age" required />
            <x-input-error for="age" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-label for="like" value="{{ __('好きなもの') }}" />
            <x-input id="like" type="text" class="mt-1 block w-full" wire:model="state.like" required />
            <x-input-error for="like" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-label for="body" value="{{ __('自由欄') }}" />
            <x-input id="body" class="mt-1 block w-full" wire:model="state.body" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="image" type="file" class="mt-1 block w-full" wire:model="state.image" accept="image/*"
                required />
    ...
    {{-- <x-slot name="actions">
        ...
        <x-button wire:click="$emit('saved')">
            {{ __('Save') }}
        </x-button>
    </x-slot> --}}
